#!/usr/bin/env bash
#
# testcase-example: minimal testcase / boiler-plate
#
...
#
# After the initial boiler-plate, then the actual testcase body begins, in this minimal example,
# the test-module is called to signal that the test passed.
#
...
#
# Testcase body, the above is boiler-plate, write the actual testcase below
#
